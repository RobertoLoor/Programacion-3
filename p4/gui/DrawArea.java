...
*/
/**
 * The `DrawArea` class represents a custom component for drawing shapes on a graphical user interface.
 * It extends the `JComponent` class and provides methods for drawing circles, squares, and rectangles.
 * The class also supports filling circles and rectangles with colors.
 */
