...
class MouseTracker implements Runnable {
    ...
    /**
     * The display output device.
     */
    Display display;
    
    /**
     * The number of lines printed to the output.
     */
    int linesPrinted;
    
    /**
     * Control Sequence Introducer (CSI) for ANSI escape codes.
     */
    private static final String CSI = "\033["; // CSI: Control Sequence Introducer
    
    /**
     * ANSI escape code for moving the cursor to the home position.
     */
